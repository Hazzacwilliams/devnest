...
export const addFriend = async (userid1, userid2, status) => {
    try {
        ...
        console.error(`Problem inserting new friendship into friendslist: ${err}`);
    }
};   
...
export const retrieveFriendRequests = async (userid) => {
    try {
        ...
        console.error(`Problem retrieving friend requests for user: ${err}`);
    }
}
...
export const updateFriendRequest = async (friendshipid, statusUpdate) => {
    try {
        ...
        console.error(`Problem altering friendship status!`);
    }
}
...
export const getAllFriends = async (userid) => {
    try {
        ...
        console.error(`Problem retrieving ${userid}'s friend list`)
    }
};